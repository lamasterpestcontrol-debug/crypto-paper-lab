import io,subprocess,threading,unittest
...
class T(unittest.TestCase):
    ...
    def test_four_workers_configured(self):self.assertEqual(len(launcher.COMMANDS),4);self.assertEqual(launcher.COMMANDS[-1][0],"stock_style_shadow.py")
